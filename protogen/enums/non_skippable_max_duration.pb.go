...
var file_google_ads_googleads_v20_enums_non_skippable_max_duration_proto_goTypes = []interface{}{
...
func file_google_ads_googleads_v20_enums_non_skippable_max_duration_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v20_enums_non_skippable_max_duration_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NonSkippableMaxDurationEnum); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
