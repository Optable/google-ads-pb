...
var file_google_ads_googleads_v20_enums_lead_form_field_user_input_type_proto_goTypes = []interface{}{
...
func file_google_ads_googleads_v20_enums_lead_form_field_user_input_type_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v20_enums_lead_form_field_user_input_type_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
