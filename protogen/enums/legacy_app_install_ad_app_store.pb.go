...
var file_google_ads_googleads_v20_enums_legacy_app_install_ad_app_store_proto_goTypes = []interface{}{
...
func file_google_ads_googleads_v20_enums_legacy_app_install_ad_app_store_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v20_enums_legacy_app_install_ad_app_store_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
