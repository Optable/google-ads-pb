...
var file_google_ads_googleads_v20_enums_user_list_date_rule_item_operator_proto_goTypes = []interface{}{
...
func file_google_ads_googleads_v20_enums_user_list_date_rule_item_operator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v20_enums_user_list_date_rule_item_operator_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
