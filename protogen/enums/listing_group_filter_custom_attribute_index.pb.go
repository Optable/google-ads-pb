...
var file_google_ads_googleads_v20_enums_listing_group_filter_custom_attribute_index_proto_goTypes = []interface{}{
...
func file_google_ads_googleads_v20_enums_listing_group_filter_custom_attribute_index_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v20_enums_listing_group_filter_custom_attribute_index_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
