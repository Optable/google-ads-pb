...
var file_google_ads_googleads_v20_enums_vanity_pharma_display_url_mode_proto_goTypes = []interface{}{
...
func file_google_ads_googleads_v20_enums_vanity_pharma_display_url_mode_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v20_enums_vanity_pharma_display_url_mode_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
