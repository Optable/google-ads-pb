...
var file_google_ads_googleads_v20_enums_sk_ad_network_coarse_conversion_value_proto_goTypes = []interface{}{
...
func file_google_ads_googleads_v20_enums_sk_ad_network_coarse_conversion_value_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v20_enums_sk_ad_network_coarse_conversion_value_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
