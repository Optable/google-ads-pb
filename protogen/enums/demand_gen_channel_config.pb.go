...
var file_google_ads_googleads_v20_enums_demand_gen_channel_config_proto_goTypes = []interface{}{
...
func file_google_ads_googleads_v20_enums_demand_gen_channel_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v20_enums_demand_gen_channel_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DemandGenChannelConfigEnum); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
