...
const file_google_ads_googleads_v22_errors_criterion_error_proto_rawDesc = "" +
	"\n" +
	"5google/ads/googleads/v22/errors/criterion_error.proto\x12\x1fgoogle.ads.googleads.v22.errors\"\x884\n" +
	"\x12CriterionErrorEnum\"\xf13\n" +
	...
	"\x1fINVALID_LISTING_GROUP_HIERARCHY\x10j\x123\n" +
	...
	"7LOCATION_TARGETING_NOT_ELIGIBLE_FOR_RESTRICTED_CAMPAIGN\x10\xa6\x01\x124\n" +
	"/ONLY_INCLUSION_BRAND_LIST_ALLOWED_FOR_AD_GROUPS\x10\xab\x01\x121\n" +
	",CANNOT_ADD_REMOVED_PLACEMENT_LIST_SHARED_SET\x10\xac\x01\x12-\n" +
	"(PLACEMENT_LIST_SHARED_SET_DOES_NOT_EXIST\x10\xad\x01\x12\x1b\n" +
	"\x16AI_MAX_MUST_BE_ENABLED\x10\xae\x01\x12'\n" +
	"\"NOT_AVAILABLE_FOR_AI_MAX_CAMPAIGNS\x10\xaf\x01\x126\n" +
	"1MISSING_EU_POLITICAL_ADVERTISING_SELF_DECLARATION\x10\xb0\x01\x12<\n" +
	"7INVALID_CAMPAIGN_TYPE_FOR_THIRD_PARTY_PARTNER_DATA_LIST\x10\xb1\x01\x120\n" +
	"+CANNOT_ADD_USER_LIST_PENDING_PRIVACY_REVIEW\x10\xb2\x01B\xf3\x01\n" +
	"#com.google.ads.googleads.v22.errorsB\x13CriterionErrorProtoP\x01ZEgithub.com/Optable/google-ads-pb/protogen/errors;errors\xa2\x02\x03GAA\xaa\x02\x1fGoogle.Ads.GoogleAds.V22.Errors\xca\x02\x1fGoogle\\Ads\\GoogleAds\\V22\\Errors\xea\x02#Google::Ads::GoogleAds::V22::Errorsb\x06proto3"
