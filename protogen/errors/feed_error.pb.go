...
var file_google_ads_googleads_v20_errors_feed_error_proto_goTypes = []interface{}{
...
func file_google_ads_googleads_v20_errors_feed_error_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v20_errors_feed_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
