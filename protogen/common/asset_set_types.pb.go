...
const file_google_ads_googleads_v22_common_asset_set_types_proto_rawDesc = "" +
	"\n" +
	...
	"\x17location_ownership_type\x18\x03 \x01(\x0e2O.google.ads.googleads.v22.enums.LocationOwnershipTypeEnum.LocationOwnershipTypeB\x06\xe0A\x02\xe0A\x05R\x15locationOwnershipType\x12\x80\x01\n" +
	"\x1dbusiness_profile_location_set\x18\x01 \x01(\v2;.google.ads.googleads.v22.common.BusinessProfileLocationSetH\x00R\x1abusinessProfileLocationSet\x12Y\n" +
	"\x12chain_location_set\x18\x02 \x01(\v2).google.ads.googleads.v22.common.ChainSetH\x00R\x10chainLocationSet\x12^\n" +
	"\x11maps_location_set\x18\x05 \x01(\v20.google.ads.googleads.v22.common.MapsLocationSetH\x00R\x0fmapsLocationSetB\b\n" +
	"\x06source\"\xc5\x02\n" +
	...
	"\x11relationship_type\x18\x01 \x01(\x0e2O.google.ads.googleads.v22.enums.ChainRelationshipTypeEnum.ChainRelationshipTypeB\x06\xe0A\x02\xe0A\x05R\x10relationshipType\x12I\n" +
	"\x06chains\x18\x02 \x03(\v2,.google.ads.googleads.v22.common.ChainFilterB\x03\xe0A\x02R\x06chains\"^\n" +
	...
	"\x0emaps_locations\x18\x01 \x03(\v21.google.ads.googleads.v22.common.MapsLocationInfoB\x03\xe0A\x02R\rmapsLocations\"-\n" +
	"\x10MapsLocationInfo\x12\x19\n" +
	"\bplace_id\x18\x01 \x01(\tR\aplaceId\"\xce\x01\n" +
	"\x1cBusinessProfileLocationGroup\x12\xad\x01\n" +
	".dynamic_business_profile_location_group_filter\x18\x01 \x01(\v2J.google.ads.googleads.v22.common.DynamicBusinessProfileLocationGroupFilterR)dynamicBusinessProfileLocationGroupFilter\"\x92\x02\n" +
	")DynamicBusinessProfileLocationGroupFilter\x12#\n" +
	"\rlabel_filters\x18\x01 \x03(\tR\flabelFilters\x12y\n" +
	"\x14business_name_filter\x18\x02 \x01(\v2B.google.ads.googleads.v22.common.BusinessProfileBusinessNameFilterH\x00R\x12businessNameFilter\x88\x01\x01\x12,\n" +
	...
	"\vfilter_type\x18\x02 \x01(\x0e2U.google.ads.googleads.v22.enums.LocationStringFilterTypeEnum.LocationStringFilterTypeR\n" +
	"filterType\"\x92\x01\n" +
	"\x12ChainLocationGroup\x12|\n" +
	"$dynamic_chain_location_group_filters\x18\x01 \x03(\v2,.google.ads.googleads.v22.common.ChainFilterR dynamicChainLocationGroupFiltersB\xf2\x01\n" +
	"#com.google.ads.googleads.v22.commonB\x12AssetSetTypesProtoP\x01ZEgithub.com/Optable/google-ads-pb/protogen/common;common\xa2\x02\x03GAA\xaa\x02\x1fGoogle.Ads.GoogleAds.V22.Common\xca\x02\x1fGoogle\\Ads\\GoogleAds\\V22\\Common\xea\x02#Google::Ads::GoogleAds::V22::Commonb\x06proto3"
