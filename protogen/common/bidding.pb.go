...
const file_google_ads_googleads_v22_common_bidding_proto_rawDesc = "" +
	"\n" +
	"-google/ads/googleads/v22/common/bidding.proto\x12\x1fgoogle.ads.googleads.v22.common\x1a3google/ads/googleads/v22/enums/fixed_cpm_goal.proto\x1aIgoogle/ads/googleads/v22/enums/fixed_cpm_target_frequency_time_unit.proto\x1a?google/ads/googleads/v22/enums/target_frequency_time_unit.proto\x1aEgoogle/ads/googleads/v22/enums/target_impression_share_location.proto\"b\n" +
	"\n" +
	"Commission\x129\n" +
	...
	"\x11target_cpa_micros\x18\x04 \x01(\x03R\x0ftargetCpaMicros\"\x9e\x02\n" +
	...
	"\x14cpc_bid_floor_micros\x18\x04 \x01(\x03R\x11cpcBidFloorMicros\x12S\n" +
	"$target_roas_tolerance_percent_millis\x18\x05 \x01(\x03H\x00R targetRoasTolerancePercentMillis\x88\x01\x01B'\n" +
	"%_target_roas_tolerance_percent_millis\"\xf6\x01\n" +
	"\tTargetCpa\x12/\n" +
	...
	"\tTargetCpm\x12s\n" +
	"\x15target_frequency_goal\x18\x01 \x01(\v2=.google.ads.googleads.v22.common.TargetCpmTargetFrequencyGoalH\x00R\x13targetFrequencyGoalB\x06\n" +
	"\x04goal\"\xb3\x01\n" +
	"\x1cTargetCpmTargetFrequencyGoal\x12!\n" +
	"\ftarget_count\x18\x01 \x01(\x03R\vtargetCount\x12p\n" +
	"\ttime_unit\x18\x02 \x01(\x0e2S.google.ads.googleads.v22.enums.TargetFrequencyTimeUnitEnum.TargetFrequencyTimeUnitR\btimeUnit\"\xc5\x02\n" +
	"\x15TargetImpressionShare\x12{\n" +
	"\blocation\x18\x01 \x01(\x0e2_.google.ads.googleads.v22.enums.TargetImpressionShareLocationEnum.TargetImpressionShareLocationR\blocation\x12=\n" +
	...
	"\x17_cpc_bid_ceiling_micros\"\xe4\x02\n" +
	"\n" +
	"TargetRoas\x12$\n" +
	"\vtarget_roas\x18\x04 \x01(\x01H\x00R\n" +
	"targetRoas\x88\x01\x01\x128\n" +
	"\x16cpc_bid_ceiling_micros\x18\x05 \x01(\x03H\x01R\x13cpcBidCeilingMicros\x88\x01\x01\x124\n" +
	"\x14cpc_bid_floor_micros\x18\x06 \x01(\x03H\x02R\x11cpcBidFloorMicros\x88\x01\x01\x12S\n" +
	"$target_roas_tolerance_percent_millis\x18\a \x01(\x03H\x03R targetRoasTolerancePercentMillis\x88\x01\x01B\x0e\n" +
	"\f_target_roasB\x19\n" +
	"\x17_cpc_bid_ceiling_microsB\x17\n" +
	"\x15_cpc_bid_floor_microsB'\n" +
	"%_target_roas_tolerance_percent_millis\"\xb3\x01\n" +
	"\vTargetSpend\x127\n" +
	...
	"\bFixedCpm\x12Q\n" +
	"\x04goal\x18\x01 \x01(\x0e2=.google.ads.googleads.v22.enums.FixedCpmGoalEnum.FixedCpmGoalR\x04goal\x12v\n" +
	"\x15target_frequency_info\x18\x02 \x01(\v2@.google.ads.googleads.v22.common.FixedCpmTargetFrequencyGoalInfoH\x00R\x13targetFrequencyInfoB\v\n" +
	"\tgoal_info\"\xc7\x01\n" +
	"\x1fFixedCpmTargetFrequencyGoalInfo\x12!\n" +
	"\ftarget_count\x18\x01 \x01(\x03R\vtargetCount\x12\x80\x01\n" +
	"\ttime_unit\x18\x02 \x01(\x0e2c.google.ads.googleads.v22.enums.FixedCpmTargetFrequencyTimeUnitEnum.FixedCpmTargetFrequencyTimeUnitR\btimeUnit\"\v\n" +
	"\tTargetCpv\"7\n" +
	"\tTargetCpc\x12*\n" +
	"\x11target_cpc_micros\x18\x01 \x01(\x03R\x0ftargetCpcMicrosB\xec\x01\n" +
	"#com.google.ads.googleads.v22.commonB\fBiddingProtoP\x01ZEgithub.com/Optable/google-ads-pb/protogen/common;common\xa2\x02\x03GAA\xaa\x02\x1fGoogle.Ads.GoogleAds.V22.Common\xca\x02\x1fGoogle\\Ads\\GoogleAds\\V22\\Common\xea\x02#Google::Ads::GoogleAds::V22::Commonb\x06proto3"
