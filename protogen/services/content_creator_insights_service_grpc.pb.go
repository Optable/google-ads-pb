...
func (UnimplementedContentCreatorInsightsServiceServer) GenerateCreatorInsights(context.Context, *GenerateCreatorInsightsRequest) (*GenerateCreatorInsightsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateCreatorInsights not implemented")
}
func (UnimplementedContentCreatorInsightsServiceServer) GenerateTrendingInsights(context.Context, *GenerateTrendingInsightsRequest) (*GenerateTrendingInsightsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateTrendingInsights not implemented")
}
...
func RegisterContentCreatorInsightsServiceServer(s grpc.ServiceRegistrar, srv ContentCreatorInsightsServiceServer) {
	// If the following call panics, it indicates UnimplementedContentCreatorInsightsServiceServer was
