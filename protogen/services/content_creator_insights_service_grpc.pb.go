...
func (c *contentCreatorInsightsServiceClient) GenerateCreatorInsights(ctx context.Context, in *GenerateCreatorInsightsRequest, opts ...grpc.CallOption) (*GenerateCreatorInsightsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ContentCreatorInsightsService_GenerateCreatorInsights_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contentCreatorInsightsServiceClient) GenerateTrendingInsights(ctx context.Context, in *GenerateTrendingInsightsRequest, opts ...grpc.CallOption) (*GenerateTrendingInsightsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ContentCreatorInsightsService_GenerateTrendingInsights_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
