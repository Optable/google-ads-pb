...
func (UnimplementedAdGroupAdServiceServer) MutateAdGroupAds(context.Context, *MutateAdGroupAdsRequest) (*MutateAdGroupAdsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method MutateAdGroupAds not implemented")
}
func (UnimplementedAdGroupAdServiceServer) RemoveAutomaticallyCreatedAssets(context.Context, *RemoveAutomaticallyCreatedAssetsRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method RemoveAutomaticallyCreatedAssets not implemented")
}
...
func RegisterAdGroupAdServiceServer(s grpc.ServiceRegistrar, srv AdGroupAdServiceServer) {
	// If the following call panics, it indicates UnimplementedAdGroupAdServiceServer was
