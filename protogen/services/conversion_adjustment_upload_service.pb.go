...
const file_google_ads_googleads_v22_services_conversion_adjustment_upload_service_proto_rawDesc = "" +
	"\n" +
	"Lgoogle/ads/googleads/v22/services/conversion_adjustment_upload_service.proto\x12!google.ads.googleads.v22.services\x1a7google/ads/googleads/v22/common/offline_user_data.proto\x1a?google/ads/googleads/v22/enums/conversion_adjustment_type.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x17google/rpc/status.proto\"\xbe\x02\n" +
	"\"UploadConversionAdjustmentsRequest\x12$\n" +
	"\vcustomer_id\x18\x01 \x01(\tB\x03\xe0A\x02R\n" +
	"customerId\x12s\n" +
	"\x16conversion_adjustments\x18\x02 \x03(\v27.google.ads.googleads.v22.services.ConversionAdjustmentB\x03\xe0A\x02R\x15conversionAdjustments\x12,\n" +
	...
	"\aresults\x18\x02 \x03(\v2=.google.ads.googleads.v22.services.ConversionAdjustmentResultR\aresults\x12\x15\n" +
	"\x06job_id\x18\x03 \x01(\x03R\x05jobId\"\xb3\x05\n" +
	"\x14ConversionAdjustment\x12e\n" +
	"\x14gclid_date_time_pair\x18\f \x01(\v24.google.ads.googleads.v22.services.GclidDateTimePairR\x11gclidDateTimePair\x12\x1e\n" +
	...
	"\x0fadjustment_type\x18\x05 \x01(\x0e2U.google.ads.googleads.v22.enums.ConversionAdjustmentTypeEnum.ConversionAdjustmentTypeR\x0eadjustmentType\x12`\n" +
	"\x11restatement_value\x18\x06 \x01(\v23.google.ads.googleads.v22.services.RestatementValueR\x10restatementValue\x12Z\n" +
	"\x10user_identifiers\x18\n" +
	" \x03(\v2/.google.ads.googleads.v22.common.UserIdentifierR\x0fuserIdentifiers\x12\"\n" +
	"\n" +
	...
	"\x14gclid_date_time_pair\x18\t \x01(\v24.google.ads.googleads.v22.services.GclidDateTimePairR\x11gclidDateTimePair\x12\x19\n" +
	"\border_id\x18\n" +
	" \x01(\tR\aorderId\x120\n" +
	...
	"\x0fadjustment_type\x18\x05 \x01(\x0e2U.google.ads.googleads.v22.enums.ConversionAdjustmentTypeEnum.ConversionAdjustmentTypeR\x0eadjustmentTypeB\x14\n" +
	"\x12_conversion_actionB\x17\n" +
	"\x15_adjustment_date_time2\x95\x03\n" +
	"!ConversionAdjustmentUploadService\x12\xa8\x02\n" +
	"\x1bUploadConversionAdjustments\x12E.google.ads.googleads.v22.services.UploadConversionAdjustmentsRequest\x1aF.google.ads.googleads.v22.services.UploadConversionAdjustmentsResponse\"z\xdaA2customer_id,conversion_adjustments,partial_failure\x82\xd3\xe4\x93\x02?:\x01*\":/v22/customers/{customer_id=*}:uploadConversionAdjustments\x1aE\xcaA\x18googleads.googleapis.com\xd2A'https://www.googleapis.com/auth/adwordsB\x92\x02\n" +
	"%com.google.ads.googleads.v22.servicesB&ConversionAdjustmentUploadServiceProtoP\x01ZIgithub.com/Optable/google-ads-pb/protogen/services;services\xa2\x02\x03GAA\xaa\x02!Google.Ads.GoogleAds.V22.Services\xca\x02!Google\\Ads\\GoogleAds\\V22\\Services\xea\x02%Google::Ads::GoogleAds::V22::Servicesb\x06proto3"
