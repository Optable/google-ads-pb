...
var file_google_ads_googleads_v20_services_campaign_label_service_proto_goTypes = []interface{}{
...
func file_google_ads_googleads_v20_services_campaign_label_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v20_services_campaign_label_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v20_services_campaign_label_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v20_services_campaign_label_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v20_services_campaign_label_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v20_services_campaign_label_service_proto_msgTypes[1].OneofWrappers = []interface{}{
