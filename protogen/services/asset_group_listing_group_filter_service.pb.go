...
const file_google_ads_googleads_v22_services_asset_group_listing_group_filter_service_proto_rawDesc = "" +
	"\n" +
	...
	"customerId\x12m\n" +
	"\n" +
	"operations\x18\x02 \x03(\v2H.google.ads.googleads.v22.services.AssetGroupListingGroupFilterOperationB\x03\xe0A\x02R\n" +
	"operations\x12#\n" +
	"\rvalidate_only\x18\x03 \x01(\bR\fvalidateOnly\x12\x7f\n" +
	"\x15response_content_type\x18\x04 \x01(\x0e2K.google.ads.googleads.v22.enums.ResponseContentTypeEnum.ResponseContentTypeR\x13responseContentType\"\xff\x02\n" +
	"%AssetGroupListingGroupFilterOperation\x12;\n" +
	"\vupdate_mask\x18\x04 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\x12Z\n" +
	"\x06create\x18\x01 \x01(\v2@.google.ads.googleads.v22.resources.AssetGroupListingGroupFilterH\x00R\x06create\x12Z\n" +
	"\x06update\x18\x02 \x01(\v2@.google.ads.googleads.v22.resources.AssetGroupListingGroupFilterH\x00R\x06update\x12T\n" +
	...
	"\aresults\x18\x01 \x03(\v2K.google.ads.googleads.v22.services.MutateAssetGroupListingGroupFilterResultR\aresults\"\x96\x02\n" +
	...
	" asset_group_listing_group_filter\x18\x02 \x01(\v2@.google.ads.googleads.v22.resources.AssetGroupListingGroupFilterR\x1cassetGroupListingGroupFilter2\x9c\x03\n" +
	"#AssetGroupListingGroupFilterService\x12\xad\x02\n" +
	"#MutateAssetGroupListingGroupFilters\x12M.google.ads.googleads.v22.services.MutateAssetGroupListingGroupFiltersRequest\x1aN.google.ads.googleads.v22.services.MutateAssetGroupListingGroupFiltersResponse\"g\xdaA\x16customer_id,operations\x82\xd3\xe4\x93\x02H:\x01*\"C/v22/customers/{customer_id=*}/assetGroupListingGroupFilters:mutate\x1aE\xcaA\x18googleads.googleapis.com\xd2A'https://www.googleapis.com/auth/adwordsB\x94\x02\n" +
	"%com.google.ads.googleads.v22.servicesB(AssetGroupListingGroupFilterServiceProtoP\x01ZIgithub.com/Optable/google-ads-pb/protogen/services;services\xa2\x02\x03GAA\xaa\x02!Google.Ads.GoogleAds.V22.Services\xca\x02!Google\\Ads\\GoogleAds\\V22\\Services\xea\x02%Google::Ads::GoogleAds::V22::Servicesb\x06proto3"
