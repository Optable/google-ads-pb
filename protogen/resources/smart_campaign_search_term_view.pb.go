...
var file_google_ads_googleads_v20_resources_smart_campaign_search_term_view_proto_goTypes = []interface{}{
...
func file_google_ads_googleads_v20_resources_smart_campaign_search_term_view_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v20_resources_smart_campaign_search_term_view_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
