...
var file_google_ads_googleads_v20_resources_ad_proto_goTypes = []interface{}{
...
func file_google_ads_googleads_v20_resources_ad_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v20_resources_ad_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Ad); i {
			case 0:
				return &v.state
			case 1:
	...
	file_google_ads_googleads_v20_resources_ad_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Ad_TextAd)(nil),
