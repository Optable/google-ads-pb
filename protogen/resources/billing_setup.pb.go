...
var file_google_ads_googleads_v20_resources_billing_setup_proto_goTypes = []interface{}{
...
func file_google_ads_googleads_v20_resources_billing_setup_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v20_resources_billing_setup_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v20_resources_billing_setup_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v20_resources_billing_setup_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*BillingSetup_StartDateTime)(nil),
		(*BillingSetup_StartTimeType)(nil),
		(*BillingSetup_EndDateTime)(nil),
		(*BillingSetup_EndTimeType)(nil),
	}
	file_google_ads_googleads_v20_resources_billing_setup_proto_msgTypes[1].OneofWrappers = []interface{}{}
	type x struct{}
