...
var file_google_ads_googleads_v20_resources_detail_placement_view_proto_goTypes = []interface{}{
...
func file_google_ads_googleads_v20_resources_detail_placement_view_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v20_resources_detail_placement_view_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v20_resources_detail_placement_view_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
