...
const file_google_ads_googleads_v22_resources_conversion_value_rule_proto_rawDesc = "" +
	...
	"\x06action\x18\x03 \x01(\v2G.google.ads.googleads.v22.resources.ConversionValueRule.ValueRuleActionR\x06action\x12\x8b\x01\n" +
	"\x16geo_location_condition\x18\x04 \x01(\v2U.google.ads.googleads.v22.resources.ConversionValueRule.ValueRuleGeoLocationConditionR\x14geoLocationCondition\x12{\n" +
	"\x10device_condition\x18\x05 \x01(\v2P.google.ads.googleads.v22.resources.ConversionValueRule.ValueRuleDeviceConditionR\x0fdeviceCondition\x12\x81\x01\n" +
	"\x12audience_condition\x18\x06 \x01(\v2R.google.ads.googleads.v22.resources.ConversionValueRule.ValueRuleAudienceConditionR\x11audienceCondition\x12\x84\x01\n" +
	"\x13itinerary_condition\x18\t \x01(\v2S.google.ads.googleads.v22.resources.ConversionValueRule.ValueRuleItineraryConditionR\x12itineraryCondition\x12P\n" +
	"\x0eowner_customer\x18\a \x01(\tB)\xe0A\x03\xfaA#\n" +
	"!googleads.googleapis.com/CustomerR\rownerCustomer\x12o\n" +
	"\x06status\x18\b \x01(\x0e2W.google.ads.googleads.v22.enums.ConversionValueRuleStatusEnum.ConversionValueRuleStatusR\x06status\x1a\x90\x01\n" +
	"\x0fValueRuleAction\x12g\n" +
	"\toperation\x18\x01 \x01(\x0e2I.google.ads.googleads.v22.enums.ValueRuleOperationEnum.ValueRuleOperationR\toperation\x12\x14\n" +
	...
	"\x17excluded_geo_match_type\x18\x02 \x01(\x0e2_.google.ads.googleads.v22.enums.ValueRuleGeoLocationMatchTypeEnum.ValueRuleGeoLocationMatchTypeR\x14excludedGeoMatchType\x12a\n" +
	"\x14geo_target_constants\x18\x03 \x03(\tB/\xfaA,\n" +
	"*googleads.googleapis.com/GeoTargetConstantR\x12geoTargetConstants\x12\x85\x01\n" +
	"\x0egeo_match_type\x18\x04 \x01(\x0e2_.google.ads.googleads.v22.enums.ValueRuleGeoLocationMatchTypeEnum.ValueRuleGeoLocationMatchTypeR\fgeoMatchType\x1a\x8a\x01\n" +
	"\x18ValueRuleDeviceCondition\x12n\n" +
	"\fdevice_types\x18\x01 \x03(\x0e2K.google.ads.googleads.v22.enums.ValueRuleDeviceTypeEnum.ValueRuleDeviceTypeR\vdeviceTypes\x1a\xb6\x01\n" +
	...
	"\x16advance_booking_window\x18\x01 \x01(\v2^.google.ads.googleads.v22.resources.ConversionValueRule.ValueRuleItineraryAdvanceBookingWindowR\x14advanceBookingWindow\x12{\n" +
	"\rtravel_length\x18\x02 \x01(\v2V.google.ads.googleads.v22.resources.ConversionValueRule.ValueRuleItineraryTravelLengthR\ftravelLength\x12\x82\x01\n" +
	"\x10travel_start_day\x18\x03 \x01(\v2X.google.ads.googleads.v22.resources.ConversionValueRule.ValueRuleItineraryTravelStartDayR\x0etravelStartDay\x1a\x82\x01\n" +
	...
	"&com.google.ads.googleads.v22.resourcesB\x18ConversionValueRuleProtoP\x01ZKgithub.com/Optable/google-ads-pb/protogen/resources;resources\xa2\x02\x03GAA\xaa\x02\"Google.Ads.GoogleAds.V22.Resources\xca\x02\"Google\\Ads\\GoogleAds\\V22\\Resources\xea\x02&Google::Ads::GoogleAds::V22::Resourcesb\x06proto3"
