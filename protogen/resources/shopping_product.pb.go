...
var file_google_ads_googleads_v20_resources_shopping_product_proto_goTypes = []interface{}{
...
func file_google_ads_googleads_v20_resources_shopping_product_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v20_resources_shopping_product_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v20_resources_shopping_product_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v20_resources_shopping_product_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v20_resources_shopping_product_proto_msgTypes[1].OneofWrappers = []interface{}{}
	type x struct{}
