...
var file_google_ads_googleads_v20_resources_local_services_lead_proto_goTypes = []interface{}{
...
func file_google_ads_googleads_v20_resources_local_services_lead_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v20_resources_local_services_lead_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v20_resources_local_services_lead_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v20_resources_local_services_lead_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Note); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_ads_googleads_v20_resources_local_services_lead_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v20_resources_local_services_lead_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
